  ...
  $cid=@$_GET['q'];
      ...
      while($row=mysqli_fetch_array($data)){
        if($i%2==0){
          ...
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='schedule.php?q=$cid&step=2&n=1&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='schedule.php?q=$cid&step=2&n=2&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='schedule.php?q=$cid&step=2&n=3&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='schedule.php?q=$cid&step=2&n=4&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='schedule.php?q=$cid&step=2&n=5&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
...
if(@$_get['step']==2)
{
  ...
  if(isset($error)){
     ...
     echo '<select name="sname" id="block_">
     ...
     echo '<input type="submit" name="submit" value="Submit" class="form-btn">
