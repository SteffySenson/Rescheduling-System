  ...
  $cid=@$_GET['q'];
      ...
      while($row=mysqli_fetch_array($data)){
        if($i%2==0){
          ...
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=1&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
            echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=1&sem=".$i."&eid=".$sid."'>".$row['P1']."</a></td>";
          $sub_id=$row['P2'];
          if($sub_id!=0){
          $sql2="select * from subject where Subject_Id=$sub_id";
          $data2=mysqli_query($conn,$sql2);
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=2&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
            echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=2&sem=".$i."&eid=".$sid."'>".$row['P2']."</a></td>";
          $sub_id=$row['P3'];
          if($sub_id!=0){
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=3&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
            echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=3&sem=".$i."&eid=".$sid."'>".$row['P3']."</a></td>";
            $sub_id=$row['P4'];
          if($sub_id!=0){
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=4&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
            echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=4&sem=".$i."&eid=".$sid."'>".$row['P4']."</a></td>";
            $sub_id=$row['P5'];
          if($sub_id!=0){
          ...
          $row2=mysqli_fetch_array($data2);
          $sname=$row2['S_Name'];
          echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=5&sem=".$i."&eid=".$sid."'>".$sname."</a></td>";
          }
          else 
            echo " <td align='center' height='25'><a href='oddschedule.php?q=$cid&step=2&n=5&sem=".$i."&eid=".$sid."'>".$row['P5']."</a></td>";
          echo " </tr>";
          $i++;
          $j++;
      }
      ...
      echo " </div>";
      echo '<a href="schedule.php?q='.$cid.'"><button type="radio" class="button button1" style="text-decoration: none;">EVEN</button></a>';
    //}
//}
if(@$_get['step']==!2){
  $period=@$_GET['n'];
